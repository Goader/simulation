...
public interface IBreedPublisher {
    /**
     * Adds new observer object to the collection, so it can be informed of the changes.
     *
     * @param observer Object of the class which implements IBreedObserver interface.
     */
    void addBreedObserver(IBreedObserver observer);
     ...
     * @param observer Object of the class which implements IBreedObserver interface.
     */
    void removeBreedObserver(IBreedObserver observer);
}
